/**
 * @file lv_wingcool_demo_theme.h
 *
 */

#ifndef LV_WINGCOOL_DEMO_THEME_H
#define LV_WINGCOOL_DEMO_THEME_H
...
/*Colors*/
#define LV_WINGCOOL_DEMO_WHITE           lv_color_hex(0xffffff)
#define LV_WINGCOOL_DEMO_LIGHT           lv_color_hex(0xf3f8fe)
#define LV_WINGCOOL_DEMO_GRAY            lv_color_hex(0x8a8a8a)
#define LV_WINGCOOL_DEMO_LIGHT_GRAY      lv_color_hex(0xc4c4c4)
#define LV_WINGCOOL_DEMO_BLUE            lv_color_hex(0x2f3243) //006fb6
#define LV_WINGCOOL_DEMO_GREEN           lv_color_hex(0x4cb242)
#define LV_WINGCOOL_DEMO_RED             lv_color_hex(0xd51732)
 ...
 */
lv_theme_t * lv_wingcool_demo_theme_init(lv_color_t color_primary, lv_color_t color_secondary, uint32_t flags,
