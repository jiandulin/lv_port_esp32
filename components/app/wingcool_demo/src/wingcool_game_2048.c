...
/* 2048 Sizes */
//#define LV_WINGCOOL_2048_GAME_BOX_W				(260)
//#define LV_WINGCOOL_2048_GAME_BOX_H			    (260)
//#define LV_WINGCOOL_2048_NUMBER_BOX_W				(55)
//#define LV_WINGCOOL_2048_NUMBER_BOX_H				(55)
...
static PT_lv_wingcool_2048_game g_pt_lv_wingcool_2048_game;


struct NUMBER_BOX
{
	lv_color_t number_cbuf[LV_CANVAS_BUF_SIZE_TRUE_COLOR(LV_WINGCOOL_2048_NUMBER_BOX_W, LV_WINGCOOL_2048_NUMBER_BOX_H)];
};
...
static void lv_wingcool_game_2048_init(void);	
static void lv_wingcool_game_2048_init_board(lv_obj_t * parent, uint8_t board[SIZE][SIZE]);  	// 初始化画板，展示主界面效果
//static void lv_wingcool_game_2048_init_board_number(uint8_t board[SIZE][SIZE]);				// 初始化小方块数据
static void lv_wingcool_game_2048_draw_board(lv_obj_t * parent, char * number, \
							 uint16_t canvas_w, uint16_t canvas_h, \
							 uint16_t rect_dsc_x, uint16_t rect_dsc_y, \
							 lv_color_t rgb32);	
...
void lv_wingcool_game_2048(lv_indev_t * indev)
{
	...
	//lv_obj_set_style_local_bg_color(lv_scr_act(), LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, LV_WINGCOOL_2048_GAME_BG_COLOR);
#if 1
	...
	lv_obj_set_style_local_bg_color(bg_2048_game, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT,
			LV_WINGCOOL_2048_GAME_BG_COLOR);
	lv_obj_set_size(bg_2048_game, LV_HOR_RES, LV_VER_RES);
	lv_obj_set_y(bg_2048_game, LV_WINGCOOL_DEMO_BG_FULL);
#endif // 0
    //lv_100ask_demo_anim_out_all(lv_scr_act(), 0);
    //lv_100ask_demo_anim_bg(0, LV_WINGCOOL_2048_GAME_BG_COLOR, LV_WINGCOOL_DEMO_BG_FULL);  // 调整页面背景


	/* 创建画布 */
//	static lv_color_t cbuf[LV_CANVAS_BUF_SIZE_TRUE_COLOR(LV_WINGCOOL_2048_GAME_BOX_W, LV_WINGCOOL_2048_GAME_BOX_H)];
	lv_color_t cbuf[LV_CANVAS_BUF_SIZE_TRUE_COLOR(LV_WINGCOOL_2048_GAME_BOX_W, LV_WINGCOOL_2048_GAME_BOX_H)];
	...
	lv_canvas_set_buffer(game_2048_canvas, cbuf, LV_WINGCOOL_2048_GAME_BOX_W, LV_WINGCOOL_2048_GAME_BOX_H, LV_IMG_CF_TRUE_COLOR);
	lv_obj_align(game_2048_canvas, NULL, LV_ALIGN_CENTER, 0, 0);
	lv_canvas_fill_bg(game_2048_canvas, LV_WINGCOOL_2048_GAME_BOX_COLOR, LV_OPA_COVER);
	...
	add_back(back_to_home_event_cb_1);
...
void lv_wingcool_game_2048(lv_indev_t * indev)
{
	play_2048_indev = indev;
	/* 申请内存 */
	g_pt_lv_wingcool_2048_game = (T_lv_wingcool_2048_game *)malloc(sizeof(T_lv_wingcool_2048_game));
	
	/* 初始化桌面背景 */
	g_pt_lv_wingcool_2048_game->bg = lv_obj_create(lv_scr_act(), NULL);
	lv_obj_set_size(g_pt_lv_wingcool_2048_game->bg, LV_HOR_RES, LV_VER_RES);
	lv_obj_set_y(g_pt_lv_wingcool_2048_game->bg, 40);

	/* 初始化游戏舞台 */
	g_pt_lv_wingcool_2048_game->canvas_stage = lv_obj_create(g_pt_lv_wingcool_2048_game->bg, NULL);
    lv_obj_set_style_local_radius(g_pt_lv_wingcool_2048_game->canvas_stage, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, 0); // 设置圆角
    lv_obj_set_style_local_bg_color(g_pt_lv_wingcool_2048_game->canvas_stage, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, LV_WINGCOOL_2048_GAME_BOX_COLOR); //设置颜色
	lv_obj_set_size(g_pt_lv_wingcool_2048_game->canvas_stage, LV_WINGCOOL_2048_GAME_BOX_W, LV_WINGCOOL_2048_GAME_BOX_H);
	lv_obj_align(g_pt_lv_wingcool_2048_game->canvas_stage, NULL, LV_ALIGN_IN_TOP_MID, 0, 0);
	
	/* 初始化主界面 */
	g_pt_lv_wingcool_2048_game->play_game = true;
	g_pt_lv_wingcool_2048_game->current_score_value = 0;
	lv_wingcool_game_2048_init();
	
	/* 分配屏幕触摸事件处理 */
	lv_obj_set_click(g_pt_lv_wingcool_2048_game->canvas_stage, true);
	lv_obj_set_event_cb(g_pt_lv_wingcool_2048_game->canvas_stage, play_2048_event_cb);  
	lv_obj_set_event_cb(g_pt_lv_wingcool_2048_game->bg, play_2048_event_cb);  
...
//	lv_wingcool_demo_anim_top_to_bottom(back, 200);
}


/*
 *  函数名：   static void lv_wingcool_game_2048_init(void)
 *  输入参数： 无
 *  返回值：   无
 *  函数作用： 应用界面初始化
*/
...
{
	/* 游戏说明 */
	lv_obj_t * game_title = lv_label_create(g_pt_lv_wingcool_2048_game->bg, NULL);
	lv_obj_set_style_local_text_font(game_title, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, &lv_font_montserrat_12);             // 设置文字大小
	lv_label_set_recolor(game_title, true); 					 /*Enable re-coloring by commands in the text*/
	lv_label_set_align(game_title, LV_ALIGN_OUT_TOP_LEFT);		 /*Center aligned lines*/
	lv_obj_align(game_title, g_pt_lv_wingcool_2048_game->canvas_stage, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 0);
	lv_label_set_text(game_title, "#776e65 2048# ");

	lv_obj_t * game_tutorial = lv_label_create(g_pt_lv_wingcool_2048_game->bg, NULL);
	lv_obj_set_style_local_text_font(game_tutorial, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, &lv_font_montserrat_10);
	lv_label_set_align(game_tutorial, LV_ALIGN_OUT_LEFT_MID);		 /*Center aligned lines*/
	lv_obj_align(game_tutorial, g_pt_lv_wingcool_2048_game->canvas_stage, LV_ALIGN_OUT_LEFT_TOP, -50, 30);
	lv_label_set_text(game_tutorial, "Join the tiles, \nget to 2048!\n");
	//lv_label_set_text(game_tutorial, "合并色块，得出更大的数字！");
	lv_obj_set_width(game_tutorial, 20);

//	/* LOGO */
//    LV_IMG_DECLARE(wingcool_logo);
//    lv_obj_t * logo = lv_img_create(g_pt_lv_wingcool_2048_game->bg, NULL);
//    lv_img_set_src(logo, &wingcool_logo);
//	lv_obj_align(logo, game_tutorial,  LV_ALIGN_OUT_BOTTOM_MID, 0, 0);  //(lv_obj_get_width(logo)/4)

	/* 公司信息 */
    lv_obj_t * label_logo = lv_label_create(g_pt_lv_wingcool_2048_game->bg, NULL);
	lv_obj_set_style_local_text_font(label_logo, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, &lv_font_montserrat_10);             // 设置文字大小
    lv_label_set_text(label_logo,  "wingcool.cn");
    lv_obj_align(label_logo, game_tutorial, LV_ALIGN_OUT_BOTTOM_MID, 0, 0);

	/* 最高记录显示区域 */
	lv_obj_t * obj_best_source = lv_obj_create(g_pt_lv_wingcool_2048_game->bg, NULL);
	lv_obj_set_size(obj_best_source, 45, 35);
	lv_obj_align(obj_best_source, g_pt_lv_wingcool_2048_game->canvas_stage, LV_ALIGN_OUT_RIGHT_TOP, 2, 0);

	/* 最高记录标题 */
	lv_obj_t * best_source_tip_text  = lv_label_create(obj_best_source, NULL); /* 创建标签 */
	lv_obj_set_style_local_text_font(best_source_tip_text, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, &lv_font_montserrat_12);
	lv_label_set_text(best_source_tip_text, "BEST");
	lv_obj_align(best_source_tip_text, NULL, LV_ALIGN_IN_TOP_MID, 0, 0);  /* 居中 */

	/* 最高记录分数 */
	g_pt_lv_wingcool_2048_game->label_best_score = lv_label_create(obj_best_source, NULL); /* 创建标签 */
	lv_obj_set_style_local_text_font(g_pt_lv_wingcool_2048_game->label_best_score, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, &lv_font_montserrat_12);
	lv_label_set_text(g_pt_lv_wingcool_2048_game->label_best_score, "4096");
	lv_obj_align(g_pt_lv_wingcool_2048_game->label_best_score, NULL, LV_ALIGN_IN_BOTTOM_MID, 0, 0);  /* 居中 */

	/* 当前分数显示区域 */
	lv_obj_t * obj_current_source = lv_obj_create(g_pt_lv_wingcool_2048_game->bg, NULL);
	lv_obj_set_size(obj_current_source, 45, 35);
	lv_obj_align(obj_current_source, obj_best_source, LV_ALIGN_OUT_BOTTOM_MID, 2, (lv_obj_get_height(obj_best_source)/2));

	/* 当前分提示 */
	lv_obj_t *  current_source_tip_text  = lv_label_create(obj_current_source, NULL); /* 创建标签 */
	lv_obj_set_style_local_text_font(current_source_tip_text, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, &lv_font_montserrat_12);
	lv_label_set_text(current_source_tip_text, "SORCE");
	lv_obj_align(current_source_tip_text, NULL, LV_ALIGN_IN_TOP_MID, 0, 0);           /* 居中 */

	/* 当前分数 */
	g_pt_lv_wingcool_2048_game->label_current_score = lv_label_create(obj_current_source, NULL);         /* 创建标签 */
	lv_obj_set_style_local_text_font(g_pt_lv_wingcool_2048_game->label_current_score, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, &lv_font_montserrat_12);
	lv_label_set_text(g_pt_lv_wingcool_2048_game->label_current_score, "0");
	lv_obj_align(g_pt_lv_wingcool_2048_game->label_current_score, NULL, LV_ALIGN_IN_BOTTOM_MID, 0, 0);   /* 当前画布居中 */
	
	/* 初始化游戏数字 */
//	lv_wingcool_game_2048_init_board_number(g_pt_lv_wingcool_2048_game->game_board);
	initBoardNumber(g_pt_lv_wingcool_2048_game->game_board);

	/* 初始化游戏舞台中的每个方格块 */
	lv_wingcool_game_2048_init_board(g_pt_lv_wingcool_2048_game->canvas_stage, g_pt_lv_wingcool_2048_game->game_board);
}
...
LV_EVENT_CB_DECLARE(play_2048_event_cb)
{
	...
	if (e == LV_EVENT_CLICKED)
	{
		...
		bool success = false;
//		printf("		 GAME BEGIN!			\n");
//		printf("lv_indev_get_gesture_dir: %d\n", lv_indev_get_gesture_dir(play_2048_indev));
		switch(lv_indev_get_gesture_dir(play_2048_indev))
		{
			case LV_GESTURE_DIR_TOP:
				success = moveLeft(g_pt_lv_wingcool_2048_game->game_board); 
				break;
			case LV_GESTURE_DIR_BOTTOM:
				success = moveRight(g_pt_lv_wingcool_2048_game->game_board);
				break;
			case LV_GESTURE_DIR_RIGHT:
				success = moveDown(g_pt_lv_wingcool_2048_game->game_board);
				break;
			case LV_GESTURE_DIR_LEFT:
				success = moveUp(g_pt_lv_wingcool_2048_game->game_board);
				break;
			default: 
				success = false;
		}
		...
		{
			lv_wingcool_game_2048_init_board(g_pt_lv_wingcool_2048_game->canvas_stage, g_pt_lv_wingcool_2048_game->game_board);
			addRandom(g_pt_lv_wingcool_2048_game->game_board);
			lv_wingcool_game_2048_init_board(g_pt_lv_wingcool_2048_game->canvas_stage, g_pt_lv_wingcool_2048_game->game_board);
			if (gameEnded(g_pt_lv_wingcool_2048_game->game_board))
			{
				printf("		 GAME OVER			\n");
				play_game = false;
			}
...
/*
 *  函数名：   static void lv_wingcool_game_2048_init_board(lv_obj_t * parent, uint8_t board[SIZE][SIZE])
 *  输入参数： 父对象
 *  返回值：   需要操作的数组
 *  函数作用： 初始化画板，展示主界面效果
*/
static void lv_wingcool_game_2048_init_board(lv_obj_t * parent, uint8_t board[SIZE][SIZE])
{
	/* 清除之前所有的子对象 */
    lv_obj_clean(parent);  
	...
	lv_label_set_text(g_pt_lv_wingcool_2048_game->label_current_score, Int2String(g_pt_lv_wingcool_2048_game->current_score_value, str_current_score));
	...
	for(int y = 0; y < SIZE; y++)
	{
		for(int x = 0; x < SIZE; x++)
		{
			if (board[x][y]!=0) {
				...
				lv_wingcool_game_2048_draw_board(parent, tmp_char,\
						  LV_WINGCOOL_2048_NUMBER_BOX_W, LV_WINGCOOL_2048_NUMBER_BOX_H, \
						  (8*(y+1))+(LV_WINGCOOL_2048_NUMBER_BOX_W*(y+1-1)), (8*(x+1))+(LV_WINGCOOL_2048_NUMBER_BOX_W*(x+1-1)), Num2Color((uint32_t)1<<board[x][y]));
			}
			else {
				lv_wingcool_game_2048_draw_board(parent, "",\
						  LV_WINGCOOL_2048_NUMBER_BOX_W, LV_WINGCOOL_2048_NUMBER_BOX_H, \
						  (8*(y+1))+(LV_WINGCOOL_2048_NUMBER_BOX_W*(y+1-1)), (8*(x+1))+(LV_WINGCOOL_2048_NUMBER_BOX_W*(x+1-1)), LV_WINGCOOL_2048_NUMBER_BOX_COLOR);
			}
		}
	}
}
...
/*
 *  函数名：   static void lv_wigncool_game_2048_draw_board(lv_obj_t * parent, char * number, \
														 uint16_t canvas_w, uint16_t canvas_h, \
														 uint16_t rect_dsc_x, uint16_t rect_dsc_y, \
														 lv_color_t rgb32)
 *  输入参数： 绘制所依托的父对象
							 ...
							 lv_color_t rgb32)
{
	...
	lv_obj_set_style_local_text_font(obj, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, &lv_font_montserrat_12); // 字体大小
...
//	static struct NUMBER_BOX s_number_cbuf[SIZE][SIZE];
	struct NUMBER_BOX s_number_cbuf[SIZE][SIZE];


	/* 创建画布 */
//	static lv_color_t best_source_cbuf[LV_CANVAS_BUF_SIZE_TRUE_COLOR(135, 75)];
	lv_color_t best_source_cbuf[LV_CANVAS_BUF_SIZE_TRUE_COLOR(65, 35)];
	...
	lv_canvas_set_buffer(best_source_canvas, best_source_cbuf, 65, 35, LV_IMG_CF_TRUE_COLOR);
	...
	best_source_rect_dsc.bg_color = LV_WINGCOOL_2048_GAME_BOX_COLOR;
	lv_canvas_draw_rect(best_source_canvas, 0, 0, 65, 35, &best_source_rect_dsc);

	/* 最高分提示 */
	lv_obj_t * best_source_tip_text  = lv_label_create(best_source_canvas, NULL); /* 创建标签 */
	lv_theme_apply(best_source_tip_text, (lv_theme_style_t)LV_DEMO_PRINTER_THEME_TITLE);
	lv_label_set_text(best_source_tip_text, "BEST");
	...
	lv_theme_apply(game_2048_best_score, (lv_theme_style_t)LV_DEMO_PRINTER_THEME_TITLE);
...
//	static lv_color_t current_source_cbuf[LV_CANVAS_BUF_SIZE_TRUE_COLOR(135, 75)];
	lv_color_t current_source_cbuf[LV_CANVAS_BUF_SIZE_TRUE_COLOR(65, 35)];
	...
	lv_canvas_set_buffer(current_source_canvas, current_source_cbuf, 65, 35, LV_IMG_CF_TRUE_COLOR);
	...
	current_source_rect_dsc.bg_color = LV_WINGCOOL_2048_GAME_BOX_COLOR;
	lv_canvas_draw_rect(current_source_canvas, 0, 0, 65, 35, &current_source_rect_dsc);

	/* 当前分提示 */
	lv_obj_t *  current_source_tip_text  = lv_label_create(current_source_canvas, NULL); /* 创建标签 */
	lv_theme_apply(current_source_tip_text, (lv_theme_style_t)LV_DEMO_PRINTER_THEME_TITLE);
	lv_label_set_text(current_source_tip_text, "SORCE");
	...
	lv_theme_apply(game_2048_current_score_text, (lv_theme_style_t)LV_DEMO_PRINTER_THEME_TITLE);
	...
	lv_theme_apply(game_title, (lv_theme_style_t)LV_DEMO_PRINTER_THEME_TITLE);
		...
		for(int x = 0; x < SIZE; x++)
		{
			if (board[x][y]!=0) {
				...
				drawBoard(parent, s_number_cbuf[x][y].number_cbuf, tmp_char,\
						  LV_WINGCOOL_2048_NUMBER_BOX_W, LV_WINGCOOL_2048_NUMBER_BOX_H, \
						  (16*(y+1))+(LV_WINGCOOL_2048_NUMBER_BOX_W*(y+1-1)), (16*(x+1))+(LV_WINGCOOL_2048_NUMBER_BOX_W*(x+1-1)), Num2Color((uint32_t)1<<board[x][y]));
			}
			else {
				drawBoard(parent, s_number_cbuf[x][y].number_cbuf, "",\
						  LV_WINGCOOL_2048_NUMBER_BOX_W, LV_WINGCOOL_2048_NUMBER_BOX_H, \
						  (16*(y+1))+(LV_WINGCOOL_2048_NUMBER_BOX_W*(y+1-1)), (16*(x+1))+(LV_WINGCOOL_2048_NUMBER_BOX_W*(x+1-1)), LV_WINGCOOL_2048_NUMBER_BOX_COLOR);
			}
		}
	}
#endif
							 ...
							 lv_color_t rgb32)
{
	...
	lv_theme_apply(icon, (lv_theme_style_t)LV_DEMO_PRINTER_THEME_TITLE);
...
static lv_color_t Num2Color(uint32_t num){
	switch (num)
	{
	case 2:		return LV_WINGCOOL_2048_NUMBER_2_COLOR;	break;
	case 4:		return LV_WINGCOOL_2048_NUMBER_4_COLOR;	break;
	case 8:		return LV_WINGCOOL_2048_NUMBER_8_COLOR;	break;
	case 16:	return LV_WINGCOOL_2048_NUMBER_16_COLOR;	break;
	case 32:	return LV_WINGCOOL_2048_NUMBER_32_COLOR;	break;
	case 64:	return LV_WINGCOOL_2048_NUMBER_64_COLOR;	break;
	case 128:	return LV_WINGCOOL_2048_NUMBER_128_COLOR;	break;
	case 256:	return LV_WINGCOOL_2048_NUMBER_256_COLOR;	break;
	case 512:	return LV_WINGCOOL_2048_NUMBER_512_COLOR;	break;
	case 1024:	return LV_WINGCOOL_2048_NUMBER_1024_COLOR;break;
	case 2048:	return LV_WINGCOOL_2048_NUMBER_2048_COLOR;break;
	default:	return LV_WINGCOOL_2048_NUMBER_2048_COLOR;break;
	}
